package com.healthup.project.config;
...
@Configuration
@EnableJpaRepositories(basePackages = { "com.healthup.project.repository" },    // Repository 경로
...
public class MariaDBConnectionConfig {
    ...
    public LocalContainerEntityManagerFactoryBean baseEntityManager() {
        ...
        // Entiry Package 경로
        em.setPackagesToScan(new String[] { "com.healthup.project.model" });
